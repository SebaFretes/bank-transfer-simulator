...
import zetaBanner from '../../../src/assets/zetasuite_cover.jpeg'
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="w-full max-w-lg">
        <img
          src={zetaBanner}
          className="w-full rounded-2xl mb-8 object-cover max-h-40"
          alt="Zeta Bank"
        />
        ...
        <div className="bg-gray-900 dark:bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-xl">
              ...
              <div className="flex items-center gap-3 mt-3 bg-gray-800 rounded-xl px-4 py-3 border border-gray-700">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 capitalize">
                    {selectedFrom.type} · ${selectedFrom.balance.toLocaleString()}
                  </p>
                </div>
              </div>
            )}
          ...
          <div className="flex justify-center my-4">
            <div className="w-8 h-8 rounded-full bg-[#6B21FF]/20 border border-[#6B21FF]/40 flex items-center justify-center text-[#6B21FF]">
              ↓
            </div>
          </div>
            ...
            {selectedTo && (
              <div className="flex items-center gap-3 mt-3 bg-gray-800 rounded-xl px-4 py-3 border border-gray-700">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 capitalize">
                    {selectedTo.type} · ${selectedTo.balance.toLocaleString()}
                  </p>
                </div>
              </div>
            )}
          ...
          <button
            ...
            className="w-full bg-[#6B21FF] hover:bg-[#5B11EF] active:scale-95 text-white font-semibold py-3 rounded-xl transition-all duration-200 shadow-lg shadow-[#6B21FF]/25"
          >
            {t('transfer.confirm')}
          </button>
        </div>
